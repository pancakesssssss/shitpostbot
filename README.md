...
- Cannot chat with you

# How to run?
Requires python3 python3-pip

1. Download source
2. add your bot token to the config.json
3. Type `pip3 install -r requirements.txt --break-system-packages` to install required shit
4. then type `python3 bot.py` to run the bot
